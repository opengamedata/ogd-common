...
class OuterfaceFactory:
    @staticmethod
    def FromConfig(config:GameStoreConfig, export_modes:Set[ExportMode], repository:LocalDatasetRepositoryConfig, dataset_id:str)-> Outerface:
    ...
    @staticmethod
    def FromDict(name:str, all_elements:Dict[str, Any], export_modes:Set[ExportMode], repository:LocalDatasetRepositoryConfig, dataset_id:str)-> Outerface:
