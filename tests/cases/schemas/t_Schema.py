...
_config = TestConfigSchema.FromDict(name="SchemaTestConfig", all_elements=settings, logger=None)
...
class t_Schema(TestCase):
    ...
    class TestSchema(Schema):
        ...
        @staticmethod
        def FromDict(name:str, all_elements:Dict[str, Any], logger:Optional[logging.Logger]=None)-> "t_Schema.TestSchema":
