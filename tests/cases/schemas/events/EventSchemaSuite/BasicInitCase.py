...
class BasicInitCase(TestCase):
    """EventSchema test case where basic initialization is used.
    
    TODO: Actually implement the class
    
    Fixture:
    * Initialize a `EventSchema` object with hardcoded values for all `__init__(...)` params
    ...
    * Property functions
    ...
    def setUpClass(cls) -> None:
        ...
        Since this class currently just tests properties, we go ahead and use a single instance of `EventSchema` shared across the class.
