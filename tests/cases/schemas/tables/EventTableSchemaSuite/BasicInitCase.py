...
class BasicInitCase(TestCase):
    """EventTableSchema test case where basic initialization is used.

    TODO : Implement and enable tests.
    
    Fixture:
    * Initialize a `EventTableSchema` object with hardcoded values for all `__init__(...)` params
    ...
    * Property functions
    ...
    def setUpClass(cls) -> None:
        ...
        Since this class currently just tests properties, we go ahead and use a single instance of `EventTableSchema` shared across the class.
